...
const navItems: NavItem[] = [
  { label: "Inicio", href: "/main/dashboard", icon: <Home className="h-5 w-5" /> },
  { label: "Movimientos", href: "#", icon: <LineChart className="h-5 w-5" /> },
  { label: "Presupuesto", href: "/main/budget", icon: <Wallet className="h-5 w-5" /> },
    ...
    <div className="min-h-dvh bg-neutral-50 text-neutral-900">
      ...
      <aside className="hidden md:flex fixed inset-y-0 left-0 w-64 flex-col border-r border-neutral-200 bg-white/80 backdrop-blur">
        <div className="px-5 pt-6 pb-4">
          <div className="text-lg font-semibold tracking-tight">Gestión de Gastos</div>
        ...
        <div className="p-4">
          <Link href="/main/add-expense-income" className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 hover:bg-blue-700 px-4 py-2 text-white shadow-lg shadow-blue-600/20">
      ...
      <nav className="md:hidden fixed bottom-0 inset-x-0 z-50 border-t border-neutral-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="mx-auto max-w-3xl grid grid-cols-5 items-end gap-1 px-4 py-2 pb-[calc(env(safe-area-inset-bottom)+0.5rem)]">
          ...
          <div className="relative flex items-center justify-center">
            <Link href="/main/add-expense-income" className="-translate-y-6 rounded-full bg-blue-600 p-4 text-white shadow-xl shadow-blue-600/30">
